...
export const grammarExamples: GrammarExample[] = [
  ...
  {
    japanese: 'この ケーキは おいしくないです',
    english: 'This cake is not delicious',
    category: 'adjectives',
    difficulty: 'hard',
    pattern: 'この Xは Yくないです',
    hint: 'Negative い-adjective'
  },
  {
    japanese: 'その えいがは おもしろくなかったです',
    english: 'That movie was not interesting',
    category: 'adjectives',
    difficulty: 'hard',
    pattern: 'その Xは Yくなかったです',
    hint: 'Negative past い-adjective'
  },
  {
    japanese: 'この レストランは しずかではありません',
    english: 'This restaurant is not quiet',
    category: 'adjectives',
    difficulty: 'hard',
    pattern: 'この Xは Yではありません',
